...
type ListTemplatesQueryParams struct {
	...
	PageSize *int32 `key:"pageSize"`
	// SortDir : sortDir
	SortDir ListTemplatessortDir `key:"sortDir"`
	// SortField : sortField
	SortField ListTemplatessortField `key:"sortField"`
}
...
func (q ListTemplatesQueryParams) SetSortDir(v ListTemplatessortDir) ListTemplatesQueryParams {
	q.SortDir = v
	return q
}

func (q ListTemplatesQueryParams) SetSortField(v ListTemplatessortField) ListTemplatesQueryParams {
	q.SortField = v
	return q
}

// ListTemplatessortDir : sortDir
type ListTemplatessortDir string

// List of ListTemplatessortDir values
const (
	ListTemplatessortDirAsc  ListTemplatessortDir = "asc"
	ListTemplatessortDirDesc ListTemplatessortDir = "desc"
)

// ListTemplatessortField : sortField
type ListTemplatessortField string

// List of ListTemplatessortField values
const (
	ListTemplatessortFieldId           ListTemplatessortField = "id"
	ListTemplatessortFieldName         ListTemplatessortField = "name"
	ListTemplatessortFieldDescription  ListTemplatessortField = "description"
	ListTemplatessortFieldCreateUserId ListTemplatessortField = "createUserId"
	ListTemplatessortFieldCreateDate   ListTemplatessortField = "createDate"
)
