...
func TestParseRawDatasetLookup(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, Lookup, ds.GetKind())
...
func TestParseRawDatasetKvCollection(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, KvCollection, ds.GetKind())
...
func TestParseRawDatasetIndex(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, Index, ds.GetKind())
...
func TestParseRawDatasetMetric(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, Metric, ds.GetKind())
...
func TestParseRawDatasetImport(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, Import, ds.GetKind())
...
func TestParseRawDatasetView(t *testing.T) {
	...
	ds, err := ParseRawDataset(dsMap)
	require.Nil(t, err)
	assert.Equal(t, View, ds.GetKind())
