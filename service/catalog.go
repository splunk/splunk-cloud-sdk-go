...
func (c *CatalogService) GetDatasets() ([]model.Dataset, error) {
	url, err := c.client.BuildURL(catalogServicePrefix, version, "datasets")
	if err != nil {
		return nil, err
	}
...
func (c *CatalogService) GetDataset(name string) (*model.Dataset, error) {
	url, err := c.client.BuildURL(catalogServicePrefix, version, "datasets", name)
	if err != nil {
		return nil, err
	}
	response, err := c.client.Get(url)
...
func (c *CatalogService) DeleteDataset(datasetName string) error {
	url, err := c.client.BuildURL(catalogServicePrefix, version, "datasets", datasetName)
	if err != nil {
		return err
	}
...
func (c *CatalogService) DeleteRule(rulePath string) error {
	getDeleteURL, err := c.client.BuildURL(catalogServicePrefix, version, "rules", rulePath)
	if err != nil {
		return err
	}
...
func (c *CatalogService) GetRules() ([]model.Rule, error) {
	getRuleURL, err := c.client.BuildURL(catalogServicePrefix, version, "rules")
	if err != nil {
		return nil, err
	}
...
func (c *CatalogService) CreateRule(rule model.Rule) (*model.Rule, error) {
	postRuleURL, err := c.client.BuildURL(catalogServicePrefix, version, "rules")
	if err != nil {
		return nil, err
	}
